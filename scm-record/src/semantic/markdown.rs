        ...
        match child.kind() {
            ...
            "atx_heading" | "setext_heading" => {
                ...
                let level = if child.kind() == "atx_heading" {
                    ...
                    for marker_child in child.children(&mut level_cursor) {
                        match marker_child.kind() {
                            "atx_h1_marker" => { found_level = 1; break; }
                            "atx_h2_marker" => { found_level = 2; break; }
                            "atx_h3_marker" => { found_level = 3; break; }
                            "atx_h4_marker" => { found_level = 4; break; }
                            "atx_h5_marker" => { found_level = 5; break; }
                            "atx_h6_marker" => { found_level = 6; break; }
                            _ => continue,
                        }
                    }
                    found_level
                ...
                let heading_text = {
                    ...
                    let content_node = child.children(&mut text_cursor)
